...
Trade-offs aceitos, riscos assumidos, impacto em outras partes do sistema. Se isso gerar um risco de segurança ou uma pendência, registrar também em `../04_Seguranca_Riscos/` ou `../06_Pendencias/`.