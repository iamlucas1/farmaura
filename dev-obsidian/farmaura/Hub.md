...
- Sistema de design (cores, tipografia, layout, componentes): `09_Design_Visual/` — ver [[09_Design_Visual/Sistema_de_Design|Sistema de Design]] (espelha `farmaura/DESIGN.md` + `farmaura/.impeccable/design.json`, gerados via `/impeccable document`), [[09_Design_Visual/design-system-frontend-tokens-compartilhados|tokens compartilhados entre marketplace e internal]] e [[09_Design_Visual/Critique_2026-08-22|critique de UX/hierarquia/CTAs/SEO 2026-08-22]] (achado mais urgente: bug de especificidade de fonte — o site não renderiza na fonte documentada)
