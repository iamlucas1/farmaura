...
(function attachAccessControl(globalObject) {
  ...
  const INTERNAL_ROUTE_ACCESS = {
    [ROLE.ADMIN]: ['dash', 'pdv', 'orders', 'deliveries', 'rx', 'chat', 'chat-unblock-requests', 'crm', 'sales', 'analytics', 'quotes', 'quotes-compare', 'purchase-analytics', 'purchase-receiving', 'products', 'inventory', 'inventory-audit', 'brands', 'categories', 'health-services', 'therapeutic-classes', 'locations', 'suppliers', 'stores', 'product-trace', 'acquisition-costs', 'construction-costs', 'home-banner', 'home-brands', 'home-trends', 'launch-mode', 'deal-of-the-day', 'pricing', 'coupons', 'promotions', 'delivery-zones', 'team', 'settings'],
    [ROLE.MANAGER]: ['dash', 'pdv', 'orders', 'deliveries', 'rx', 'chat', 'chat-unblock-requests', 'crm', 'analytics', 'quotes', 'quotes-compare', 'purchase-analytics', 'purchase-receiving', 'products', 'inventory', 'inventory-audit', 'brands', 'categories', 'health-services', 'therapeutic-classes', 'locations', 'suppliers', 'home-banner', 'home-brands', 'home-trends', 'pricing', 'coupons', 'promotions', 'delivery-zones'],
