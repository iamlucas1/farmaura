...
(function attachAccessControl(globalObject) {
  ...
  const INTERNAL_ROUTE_ACCESS = {
    [ROLE.ADMIN]: ['dash', 'pdv', 'orders', 'deliveries', 'rx', 'chat', 'crm', 'sales', 'analytics', 'quotes', 'quotes-compare', 'purchase-analytics', 'purchase-receiving', 'products', 'inventory', 'inventory-audit', 'brands', 'categories', 'health-services', 'therapeutic-classes', 'locations', 'suppliers', 'stores', 'product-trace', 'acquisition-costs', 'construction-costs', 'home-banner', 'home-brands', 'launch-mode', 'deal-of-the-day', 'pricing', 'coupons', 'promotions', 'delivery-zones', 'team', 'settings'],
    [ROLE.MANAGER]: ['dash', 'pdv', 'orders', 'deliveries', 'rx', 'chat', 'crm', 'analytics', 'quotes', 'quotes-compare', 'purchase-analytics', 'purchase-receiving', 'products', 'inventory', 'inventory-audit', 'brands', 'categories', 'health-services', 'therapeutic-classes', 'locations', 'suppliers', 'home-banner', 'home-brands', 'pricing', 'coupons', 'promotions', 'delivery-zones'],
    [ROLE.PHARMACIST]: ['dash', 'pdv', 'orders', 'deliveries', 'rx', 'chat', 'crm', 'analytics', 'products', 'inventory', 'brands', 'categories', 'health-services', 'therapeutic-classes', 'locations', 'suppliers', 'home-banner', 'home-brands', 'pricing', 'coupons', 'promotions', 'delivery-zones'],
