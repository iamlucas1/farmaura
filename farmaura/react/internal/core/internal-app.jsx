...
function PharmApp() {
  ...
  const _purchaseQuoteItemFromResponse = (item) => ({
    ...
    unit: item.unit || 'un',
    unitsPerPackage: item.units_per_package == null ? null : Number(item.units_per_package),
    quantityReference: item.quantity_reference == null ? null : Number(item.quantity_reference),
    unitPrice: Number(item.unit_price || 0),
    ncmCode: item.ncm_code || '',
    ipiPercentage: item.ipi_percentage == null ? null : Number(item.ipi_percentage),
    icmsStValue: item.icms_st_value == null ? null : Number(item.icms_st_value),
  ...
  const _purchaseQuoteItemToPayload = (item) => ({
    ...
    unit: item.unit || 'un',
    units_per_package: item.unitsPerPackage === '' || item.unitsPerPackage == null ? null : Number(item.unitsPerPackage),
    ...
    ipi_percentage: item.ipiPercentage === '' || item.ipiPercentage == null ? null : Number(item.ipiPercentage),
    icms_st_value: item.icmsStValue === '' || item.icmsStValue == null ? null : Number(item.icmsStValue),
    final_unit_price: item.finalUnitPrice === '' || item.finalUnitPrice == null ? null : Number(item.finalUnitPrice),
