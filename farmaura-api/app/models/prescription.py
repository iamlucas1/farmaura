...
class Prescription(Base, UuidModel, TimestampedModel):
    ...
    delivery_method: Mapped[str] = mapped_column(String(16), default="digital", nullable=False)
    digital_reference_url: Mapped[str] = mapped_column(String(500), default="", nullable=False)
